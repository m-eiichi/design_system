...
describe("SupportText", () => {
  describe("基本的な機能", () => {
    it("基本的なレンダリングが正常に動作する", () => {
      render(<SupportText>テストコンテンツ</SupportText>);
      expect(screen.getByText("テストコンテンツ")).toBeInTheDocument();
    });

    it("classNameプロパティが正しく適用される", () => {
      const customClass = "custom-class";
      render(<SupportText className={customClass}>テスト</SupportText>);
      const component = screen.getByText("テスト");
      expect(component.className).toContain(customClass);
    });

    it("data-testidプロパティが正しく適用される", () => {
      render(<SupportText data-testid="test-component">テスト</SupportText>);
  ...
  describe("プロパティの適用", () => {
    ...
    //   render(<SupportText variant="primary">テスト</SupportText>);
    //   const component = screen.getByText("テスト");
    //   expect(hasClass(component, "size_primary")).toBe(true);
    // });

    // it("sizeプロパティが正しく適用される", () => {
    //   render(<SupportText size="large">テスト</SupportText>);
    //   const component = screen.getByText("テスト");
  ...
  describe("イベントハンドリング", () => {
    ...
    //   render(<SupportText onClick={handleClick}>テスト</SupportText>);
    //   const component = screen.getByText("テスト");
    ...
    //   const handleClick = vi.fn();
    //   render(<SupportText disabled onClick={handleClick}>テスト</SupportText>);
    //   const component = screen.getByText("テスト");
    //   fireEvent.click(component);
  ...
  describe("アクセシビリティ", () => {
    ...
    //   render(<SupportText aria-label="アクセシビリティテスト">テスト</SupportText>);
    //   const component = screen.getByLabelText("アクセシビリティテスト");
    //   expect(component).toBeInTheDocument();
    // });

    // it("role属性が正しく設定される", () => {
    //   render(<SupportText role="button">テスト</SupportText>);
  ...
  describe("エッジケース", () => {
    it("空のchildrenでも正常に動作する", () => {
      render(<SupportText></SupportText>);
      const component = screen.getByTestId("test-component");
      expect(component).toBeInTheDocument();
    });

    it("undefinedのプロパティでも正常に動作する", () => {
      render(<SupportText prop={undefined}>テスト</SupportText>);
      expect(screen.getByText("テスト")).toBeInTheDocument();
    });

    it("極端な値でもクラッシュしない", () => {
      render(<SupportText className="very-long-class-name-that-might-cause-issues">テスト</SupportText>);
      expect(screen.getByText("テスト")).toBeInTheDocument();
    });
  });
  ...
  describe("レスポンシブ対応", () => {
    ...
    //   render(<SupportText size={{ sp: "small", tb: "medium", pc: "large" }}>テスト</SupportText>);
    //   const component = screen.getByText("テスト");
  ...
  describe("状態管理", () => {
    ...
    //   render(<SupportText loading>テスト</SupportText>);
    //   const component = screen.getByText("テスト");
    //   expect(hasClass(component, "size_loading")).toBe(true);
    // });

    // it("error状態が正しく表示される", () => {
    //   render(<SupportText error>テスト</SupportText>);
    //   const component = screen.getByText("テスト");
