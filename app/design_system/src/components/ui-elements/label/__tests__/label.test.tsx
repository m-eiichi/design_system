...
describe("Label", () => {
  ...
  describe("プロパティの適用", () => {
    ...
    //   render(<Label variant="primary">テスト</Label>);
    //   const component = screen.getByText("テスト");
    //   expect(hasClass(component, "size_primary")).toBe(true);
    // });

    // it("sizeプロパティが正しく適用される", () => {
    //   render(<Label size="large">テスト</Label>);
    //   const component = screen.getByText("テスト");
  ...
  describe("イベントハンドリング", () => {
    ...
    //   render(<Label onClick={handleClick}>テスト</Label>);
    //   const component = screen.getByText("テスト");
    ...
    //   const handleClick = vi.fn();
    //   render(<Label disabled onClick={handleClick}>テスト</Label>);
    //   const component = screen.getByText("テスト");
    //   fireEvent.click(component);
  ...
  describe("アクセシビリティ", () => {
    ...
    //   render(<Label aria-label="アクセシビリティテスト">テスト</Label>);
    //   const component = screen.getByLabelText("アクセシビリティテスト");
    //   expect(component).toBeInTheDocument();
    // });

    // it("role属性が正しく設定される", () => {
    //   render(<Label role="button">テスト</Label>);
  ...
  describe("エッジケース", () => {
    ...
    it("undefinedのプロパティでも正常に動作する", () => {
      render(<Label prop={undefined}>テスト</Label>);
      expect(screen.getByText("テスト")).toBeInTheDocument();
    });

    it("極端な値でもクラッシュしない", () => {
      render(<Label className="very-long-class-name-that-might-cause-issues">テスト</Label>);
      expect(screen.getByText("テスト")).toBeInTheDocument();
    });
  });
  ...
  describe("レスポンシブ対応", () => {
    ...
    //   render(<Label size={{ sp: "small", tb: "medium", pc: "large" }}>テスト</Label>);
    //   const component = screen.getByText("テスト");
  ...
  describe("状態管理", () => {
    ...
    //   render(<Label loading>テスト</Label>);
    //   const component = screen.getByText("テスト");
    //   expect(hasClass(component, "size_loading")).toBe(true);
    // });

    // it("error状態が正しく表示される", () => {
    //   render(<Label error>テスト</Label>);
    //   const component = screen.getByText("テスト");
